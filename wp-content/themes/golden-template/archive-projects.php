...
$projects_page_title = get_option( 'golden_template_projects_page_title', 'All Projects' );
				...
				<div class="projects-listing-container">
					<?php if ( have_posts() ) : ?>
						...
						<?php if ( $projects_query->max_num_pages > 1 ) : ?>
							...
							?>
							<nav class="projects-pagination" aria-label="<?php esc_attr_e( 'Projects pagination', 'golden-template' ); ?>" data-aos="fade-up"    >
								<?php
