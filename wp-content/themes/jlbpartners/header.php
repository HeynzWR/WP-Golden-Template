...
<a class="skip-link" href="#main"><?php esc_html_e( 'Skip to main content', 'jlbpartners' ); ?></a>
...
<div id="page" class="site">
	...
	if ( $has_hero_block ) {
		...
		$logo_desktop_id = get_option( 'jlbpartners_logo_desktop_dark' );
		$logo_mobile_id  = get_option( 'jlbpartners_logo_mobile_dark' );
		...
		<div class="container container--lg">
			<div class="header__inner">
				<div class="header__logo">
					<!-- Header Logo -->
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="logo-link" aria-label="<?php echo esc_attr( get_bloginfo( 'name' ) . ' ' . __( 'Home', 'jlbpartners' ) ); ?>">
						<?php
				...
				<!-- Header Navigation -->
				<nav class="header__nav js-header-nav" aria-label="<?php esc_attr_e( 'Primary navigation', 'jlbpartners' ); ?>" id="site-navigation">
					<button class="mobile-menu-toggle js-header-toggle" aria-label="<?php esc_attr_e( 'Toggle mobile menu', 'jlbpartners' ); ?>" aria-expanded="false">
						<span class="menu-text"><?php esc_html_e( 'Menu', 'jlbpartners' ); ?></span>
					</button>
							...
							if ( has_nav_menu( 'primary' ) ) {
								wp_nav_menu(
									array(
										...
										'walker'          => new JLBPartners_Nav_Walker(),
										'fallback_cb'     => false,
									)
								);
							} else {
									...
									<ul>
										<li>
											<a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>">
												<?php esc_html_e( 'Set up your primary menu', 'jlbpartners' ); ?>
											</a>
										</li>
									</ul>
									<?php
