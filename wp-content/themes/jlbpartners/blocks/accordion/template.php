...
if ( $is_preview && empty( $accordion_items ) ) {
	jlbpartners_show_block_preview( 'accordion', __( 'Accordion Block', 'jlbpartners' ) );
	return;
}
				...
				<div class="accordion__item js-accordion-item" data-aos="fade-up">
					...
					<?php if ( $content ) : ?>
						...
						>
							...
							if ( function_exists( 'jlbpartners_accordion_get_allowed_html' ) ) {
								echo wp_kses( $content, jlbpartners_accordion_get_allowed_html() );
							} else {
