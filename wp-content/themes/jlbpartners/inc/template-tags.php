 ...
 */
function jlbpartners_format_date_with_ordinal( $post_id = null, $modified = false ) {
	if ( $modified ) {
	...
	$ordinal = jlbpartners_get_ordinal_suffix( $day );
 ...
 */
function jlbpartners_get_ordinal_suffix( $number ) {
	$number = (int) $number;
 ...
 */
function jlbpartners_posted_on() {
	$formatted_date = jlbpartners_format_date_with_ordinal();
	...
	$posted_on = sprintf(
		...
		esc_html_x( '%s', 'post date', 'jlbpartners' ),
		$time_string
	);
 ...
 */
function jlbpartners_posted_by() {
	$byline = sprintf(
		/* translators: %s: post author */
		esc_html_x( 'Posted by: %s', 'post author', 'jlbpartners' ),
