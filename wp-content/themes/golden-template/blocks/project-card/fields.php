 ...
 */
function golden_template_project_card_fields() {
...
add_action( 'acf/init', 'golden_template_project_card_fields' );

/**
 * Auto-fill fields when project is selected
 */
add_action( 'acf/input/admin_footer', 'golden_template_autofill_project_fields' );
function golden_template_autofill_project_fields() {
	$nonce = wp_create_nonce( 'golden_template_get_project_data' );
	?>
	<script>
 ...
 */
add_action( 'wp_ajax_get_project_data', 'golden_template_get_project_data_ajax' );
function golden_template_get_project_data_ajax() {
	// Verify nonce for security
	if ( ! isset( $_POST['nonce'] ) || ! wp_verify_nonce( sanitize_text_field( wp_unslash( $_POST['nonce'] ) ), 'golden_template_get_project_data' ) ) {
