...
if ( $is_preview && empty( $locations ) ) {
	golden_template_show_block_preview( 'location-cards', __( 'Location Cards Block', 'golden-template' ) );
	return;
}
...
?>
<section id="<?php echo esc_attr( $block_id ); ?>" class="section section--location-cards" data-aos="fade-up" data-aos-delay="800" data-aos-offset="-50" role="region" aria-label="<?php echo esc_attr__( 'Location Cards', 'golden-template' ); ?>">
	<div class="container">
