	...
	<section class="section section--not-found">
		<div class="container container--lg">
			<div class="jlb not-found" data-aos="fade-up">
				<h2><?php esc_html_e( '404', 'jlbpartners' ); ?></h2>
				<a class="not-found__link" href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php esc_attr_e( 'Return to homepage', 'jlbpartners' ); ?>" data-aos="fade-up">
					<span><?php esc_html_e( 'Go home', 'jlbpartners' ); ?></span>
