...
if ( $is_preview && empty( $image ) ) {
	golden_template_show_block_preview( 'image-block', __( 'Image Block', 'golden-template' ) );
	return;
}
...
?>
<section id="<?php echo esc_attr( $block_id ); ?>" class="<?php echo esc_attr( $class_name ); ?>" role="region" aria-label="<?php echo esc_attr__( 'Image Block', 'golden-template' ); ?>">
	<div class="container">
