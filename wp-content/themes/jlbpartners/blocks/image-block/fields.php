 ...
 */
function jlbpartners_image_block_fields() {
	...
	acf_add_local_field_group(
		array(
			'key'    => 'group_jlbpartners_image_block',
			'title'  => 'Image Block',
			'fields' => array(
				// Content Tab
				array(
					'key'   => 'field_jlbpartners_image_block_content_tab',
					'label' => 'Content',
					'type'  => 'tab',
				),
				// Image Field
				array(
					'key'           => 'field_jlbpartners_image_block_image',
					'label'         => 'Image',
					'name'          => 'image',
					'type'          => 'image',
				...
				// Mobile Image Field
				array(
					'key'           => 'field_jlbpartners_image_block_mobile_image',
					'label'         => 'Mobile Image',
					'name'          => 'mobile_image',
					'type'          => 'image',
				...
				array(
					'key'          => 'field_jlbpartners_image_block_image_accessibility_accordion',
				...
				// Image Role
				array(
					'key'           => 'field_jlbpartners_image_block_image_role',
					'label'         => 'Image Role',
					'name'          => 'image_role',
					'type'          => 'radio',
				...
				// ALT Text
				array(
					'key'               => 'field_jlbpartners_image_block_image_alt',
					'label'             => 'ALT Text',
					'name'              => 'image_alt',
					'type'              => 'text',
					...
					'conditional_logic' => array(
						array(
							array(
								'field'    => 'field_jlbpartners_image_block_image_role',
								'operator' => '==',
								'value'    => 'informational',
							),
						),
				...
				// Caption
				array(
					'key'          => 'field_jlbpartners_image_block_image_caption',
					'label'        => 'Caption',
					'name'         => 'image_caption',
					'type'         => 'text',
				...
				// Description
				array(
					'key'               => 'field_jlbpartners_image_block_image_description',
					'label'             => 'Description',
				...
				array(
					'key'      => 'field_jlbpartners_image_block_image_accessibility_accordion_end',
...
add_action( 'acf/init', 'jlbpartners_image_block_fields' );
 ...
 */
function jlbpartners_image_block_validate_file_size( $valid, $value, $field, $input_name ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis.UnusedVariable -- Required by ACF filter signature.
	// Only apply to image block image field.
	if ( ! isset( $field['key'] ) || 'field_jlbpartners_image_block_image' !== $field['key'] ) {
		return $valid;
	}
	...
	if ( $file_size > $max_size ) {
		...
		$valid        = sprintf(
			...
			__( 'Image file size (%1$s MB) exceeds the maximum allowed size of %2$s MB. Please compress or resize the image before uploading.', 'jlbpartners' ),
			$file_size_mb,
			'2'
		);
	}
...
add_filter( 'acf/validate_value', 'jlbpartners_image_block_validate_file_size', 10, 4 );
