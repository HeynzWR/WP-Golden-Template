 ...
 * @return array
 */
function golden_template_body_classes( $classes ) {
...
add_filter( 'body_class', 'golden_template_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function golden_template_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'golden_template_pingback_header' );
 ...
 * @return void
 */
function golden_template_footer_menu( $location ) {
