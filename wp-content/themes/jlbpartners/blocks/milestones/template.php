...
if ( $is_preview && empty( $milestone_items ) ) {
	jlbpartners_show_block_preview( 'milestones', __( 'Milestones Block', 'jlbpartners' ) );
	return;
}
...
?>
<section id="<?php echo esc_attr( $block_id ); ?>" class="<?php echo esc_attr( $class_name ); ?>" role="region" aria-label="<?php esc_attr_e( 'Milestones Timeline', 'jlbpartners' ); ?>">
