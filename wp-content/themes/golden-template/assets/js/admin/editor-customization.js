...
(function() {
	...
	function customizeBlockInserter() {
		...
		const inserterObserver = new MutationObserver(function(mutations) {
			...
			if (inserter && !inserter.classList.contains('golden_template-inserter')) {
				inserter.classList.add('golden_template-inserter');
	...
	function addInserterHelperText() {
		...
		if (!inserterHeader || document.querySelector('.golden_template-inserter-help')) {
			return;
		}

		const helpText = document.createElement('div');
		helpText.className = 'golden_template-inserter-help';
		helpText.innerHTML = `
			<div class="golden_template-inserter-help__content">
	...
	function showEnhancedPreview(blockItem, blockId) {
		// Add component badge
		if (!blockItem.querySelector('.golden_template-component-badge')) {
			const badge = document.createElement('span');
			badge.className = 'golden_template-component-badge';
		...
		if (!blockItem.querySelector('.golden_template-preview-indicator')) {
			const indicator = document.createElement('div');
			indicator.className = 'golden_template-preview-indicator';
	...
	function customizeEditorSidebar() {
		...
		if (sidebar && !document.querySelector('.golden_template-branding-indicator')) {
			const brandingIndicator = document.createElement('div');
			brandingIndicator.className = 'golden_template-branding-indicator';
	...
	wp.hooks.addFilter(
		...
		'golden_template/custom-appender-text',
