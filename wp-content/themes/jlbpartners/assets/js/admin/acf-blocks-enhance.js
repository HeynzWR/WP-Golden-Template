...
(function($) {
	...
	function showNotification(message, type) {
		...
		var $notification = $('<div></div>')
			.addClass('jlbpartners-notification')
			.addClass('jlbpartners-notification--' + type)
			.text(message);
		...
		// Fade in
		setTimeout(function() {
			$notification.addClass('jlbpartners-notification--visible');
		}, 10);
		
		// Fade out and remove after 3 seconds
		setTimeout(function() {
			$notification.removeClass('jlbpartners-notification--visible');
			setTimeout(function() {
				$notification.remove();
			}, 300);
		}, 3000);
