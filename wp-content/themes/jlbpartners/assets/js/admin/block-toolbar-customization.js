...
(function() {
				...
				createElement(
					...
					createElement(
						...
						createElement(ToolbarButton, {
							...
							className: 'jlbpartners-duplicate-button'
						}),
						createElement(ToolbarButton, {
							icon: 'trash',
							label: 'Delete Block',
							onClick: deleteBlock,
							className: 'jlbpartners-delete-button'
						})
					)
				)
			);
	...
	wp.domReady(function() {
		...
		document.body.classList.add('jlbpartners-custom-toolbar');
	});
